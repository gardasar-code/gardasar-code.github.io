...
- **Public (текущий в манифесте):** `a7fea1a873694f3ba5c27c4312b4062a` — для публичного релиза (без галочки Beta).
- **Beta (исторический):** `a46118db030d4d489268501a3e80547d` — был загружен как Beta-приложение для теста.

> Beta и публичная версии — РАЗНЫЕ app id (требование Garmin). Манифест переведён на public id.
