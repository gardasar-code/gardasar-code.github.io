...
# ТОЧКИ В ВЕРСИИ ЗАМЕНЯЕМ НА ПОДЧЁРКИВАНИЯ: устройство нормализует имя приложения
# именно так (в CIQ_LOG.YML видно `Filename: 'Di2App-0_0_44-diag'`) и пишет лог в
# GARMIN/APPS/LOGS/<нормализованное имя>.TXT. С точками в имени .prg файл лога с тем
# же написанием не совпадал с ожидаемым — и лог молча оставался пустым.
